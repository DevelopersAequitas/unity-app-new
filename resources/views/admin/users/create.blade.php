                    ...
                    <div class="col-md-4">
                        ...
                        <select name="membership_status" class="form-select">
                            @foreach ($membershipStatuses as $status)
                                <option value="{{ $status }}" @selected(($membershipSelectedStatus ?? old('membership_status', $user->membership_status)) === $status)>{{ $membershipStatusLabels[$status] ?? $status }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-4">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body row g-3">
                    ...
                    <div class="col-md-4">
                        <label class="form-label" for="active_circle_id">Add Another Circle Membership</label>
