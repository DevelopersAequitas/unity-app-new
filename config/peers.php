...
return [
    'membership_update_from_email' => env('MEMBERSHIP_UPDATE_FROM_EMAIL', 'Pravin@peersglobal.com'),
    'membership_update_from_name' => env('MEMBERSHIP_UPDATE_FROM_NAME', 'Peers Global Unity'),
    'membership_update_cc_email' => env('MEMBERSHIP_UPDATE_CC_EMAIL'),
    'membership_update_attachment_path' => env('MEMBERSHIP_UPDATE_ATTACHMENT_PATH'),

    'membership_welcome_from_email' => env('MEMBERSHIP_WELCOME_FROM_EMAIL', 'Pravin@peersglobal.com'),
    'membership_welcome_from_name' => env('MEMBERSHIP_WELCOME_FROM_NAME', 'Peers Global Unity'),
    'membership_welcome_cc_email' => env('MEMBERSHIP_WELCOME_CC_EMAIL'),
