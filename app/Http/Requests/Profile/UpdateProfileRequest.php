...
class UpdateProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'utc_offset'                  => ['sometimes', 'nullable', 'string', 'max:10'],
            'timezone_abbreviation'       => ['sometimes', 'nullable', 'string', 'max:10'],
            'current_local_time'          => ['sometimes', 'nullable', 'date'],
            'timezone_updated_at'         => ['sometimes', 'nullable', 'date'],
