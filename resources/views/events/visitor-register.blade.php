...
<div class="page">
    ...
    <section class="card">
        ...
        @endif
        <form method="post" action="{{ url('/events/'.$event->id.'/occurrences/'.$occurrence->id.'/visitor-register') }}" novalidate>
            @csrf
            <div>
            ...
            <div>
                ...
                <input id="visitor_company" name="visitor_company" value="{{ old('visitor_company') }}">
                @error('visitor_company')<div class="error">{{ $message }}</div>@enderror
            </div>
            <div>
                <label for="visitor_city">City</label>
                <input id="visitor_city" name="visitor_city" value="{{ old('visitor_city') }}">
            ...
            <div>
                ...
                <select id="visitor_business_category_main_id" name="visitor_business_category_main_id">
            ...
            <div>
                ...
                <select id="visitor_business_category_sub_id" name="visitor_business_category_sub_id">
