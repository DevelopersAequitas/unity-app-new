            ...
            <div class="card-body" id="agendaRows">
                @foreach($agendaRows as $index => $row)
                    <div class="row g-2 align-items-end mb-2 repeat-row">
                        <div class="col-md-4"><label class="form-label">Time</label><input class="form-control" name="agenda[{{ $index }}][time]" value="{{ $row['time'] ?? '' }}" placeholder="8:00 AM - 8:30 AM"></div>
                        <div class="col-md-7"><label class="form-label">Title</label><input class="form-control" name="agenda[{{ $index }}][title]" value="{{ $row['title'] ?? '' }}" placeholder="Registration & Networking"></div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('addAgendaRow').addEventListener('click', () => addRepeatRow('agendaRows', '<div class="row g-2 align-items-end mb-2 repeat-row"><div class="col-md-4"><label class="form-label">Time</label><input class="form-control" name="agenda[__INDEX__][time]" placeholder="8:00 AM - 8:30 AM"></div><div class="col-md-7"><label class="form-label">Title</label><input class="form-control" name="agenda[__INDEX__][title]" placeholder="Registration & Networking"></div><div class="col-md-1"><button type="button" class="btn btn-outline-danger w-100 remove-row">Remove</button></div></div>'));
