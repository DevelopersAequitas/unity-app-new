...
@section('title', 'Add Page Group — RBAC')
...
<div class="mb-4">
    ...
    <h1 class="h4 fw-bold mb-0">Add Page Group</h1>
</div>
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form action="{{ route('admin.rbac.page-groups.store') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-md-5">
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Group Name <span class="text-danger">*</span></label>
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="e.g. Membership Group">
                    ...
                    <div class="border rounded p-3" style="max-height:420px;overflow-y:auto">
                        ...
                        <div class="form-check">
                            <input type="checkbox" name="page_ids[]" id="page_{{ $page->id }}" value="{{ $page->id }}"
                                class="form-check-input" {{ in_array($page->id, old('page_ids', [])) ? 'checked' : '' }}>
