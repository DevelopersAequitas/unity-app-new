            ...
            <div class="card">
                ...
                <div class="card-body row g-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" min="0" name="subscription_monthly_price" class="form-control" value="{{ old('subscription_monthly_price', 0) }}">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Quarterly (3 months) - INR</label>
                        <input type="number" step="0.01" min="0" name="subscription_quarterly_price" class="form-control" value="{{ old('subscription_quarterly_price', 0) }}">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Half-Yearly (6 months) - INR</label>
                        <input type="number" step="0.01" min="0" name="subscription_half_yearly_price" class="form-control" value="{{ old('subscription_half_yearly_price', 0) }}">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Yearly (12 months) - INR</label>
                        <input type="number" step="0.01" min="0" name="subscription_yearly_price" class="form-control" value="{{ old('subscription_yearly_price', 0) }}">
                    </div>
                </div>
            </div>
        </div>
