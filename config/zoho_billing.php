...
return [
    ...
    'webhook_secret' => env('ZOHO_WEBHOOK_TOKEN', env('ZOHO_WEBHOOK_SECRET')),
    ...
    'circle_addon_interval_units' => [
        ...
        'half_yearly' => env('ZOHO_CIRCLE_INTERVAL_HALF_YEARLY', 'half_yearly'),
        'yearly' => env('ZOHO_CIRCLE_INTERVAL_YEARLY', 'yearly'),
    ],
];
