...
return [
    'membership_update_from_email' => env('MEMBERSHIP_UPDATE_FROM_EMAIL', 'pravin@peersunity.com'),
    ...
    'membership_welcome_from_email' => env('MEMBERSHIP_WELCOME_FROM_EMAIL', 'pravin@peersunity.com'),
