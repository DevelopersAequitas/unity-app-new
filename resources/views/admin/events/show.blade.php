...
<div class="container-fluid py-3">
    <div class="d-flex justify-content-between align-items-center mb-3"><h1 class="h4 mb-0">{{ $event->title }}</h1><div class="d-flex gap-2"><a href="{{ route('admin.events.scanners.index', $event->id) }}" class="btn btn-outline-info">Scanners</a><a href="{{ route('admin.events.edit', $event->id) }}" class="btn btn-outline-primary">Edit</a><a href="{{ route('admin.events.index') }}" class="btn btn-outline-secondary">Back</a></div></div>
