...
@section('content')
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
        <div>
            <h1 class="h3 mb-1 fw-bold text-dark" style="font-family: 'Outfit', sans-serif;">Register A Visitor Entries</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}" class="text-decoration-none text-muted">Admin</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.activities.register-visitor.index') }}" class="text-decoration-none text-muted">Register A Visitor</a></li>
    ...
    <div class="card-activities-wrapper">
        <div class="card-header bg-white">
            <span class="fw-bold text-dark"><i class="bi bi-person-vcard text-primary me-2"></i>Visitors Registered by this Peer</span>
        </div>
        <div class="table-responsive">
            <table class="table table-premium align-middle mb-0">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center text-muted py-4">No entries found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
