...
class WhatsappTemplateCatalogService
{
    ...
    private const CATALOG = [
        ...
        // ==========================================
        // 3. DAILY HABIT LOOP (12-DAY ONBOARDING WORKFLOW)
        // ==========================================
        'day_1_complete_profile' => [
            ...
            'category' => 'Engagement',
            'category_badge' => 'warning',
            'trigger_type' => 'Time-based (24h post-registration)',
            'trigger_title' => 'Day 1 of 12-day onboarding sequence (24h post-registration)',
            'when_sent' => 'Sent on Day 1 of the Daily Habit Loop journey exactly 24 hours after user registration to guide profile completion.',
            'description' => 'Kickstarts the 12-day member engagement journey by encouraging profile polish and brand presentation.',
            'recipient' => 'Member on Day 1 of Daily Habit Loop',
            'icon' => 'bi bi-calendar-check',
            'workflow_steps' => [
                ['title' => 'Journey Initiated', 'desc' => 'User registers and 12-day habit loop schedule is initialized'],
                ['title' => 'Schedule Day 1 (+24h)', 'desc' => 'DailyHabitLoopService sets Day 1 schedule for 24 hours after registration'],
        ...
        'business_referrals_day_2' => [
            ...
            'category' => 'Engagement',
            'category_badge' => 'warning',
            'trigger_type' => 'Time-based (48h post-registration)',
            'trigger_title' => 'Day 2 of 12-day journey (48h post-registration)',
            'when_sent' => 'Sent on Day 2 of the Daily Habit Loop journey exactly 48 hours after registration to guide member on business referrals.',
            ...
            'workflow_steps' => [
                ['title' => 'Day 2 Due', 'desc' => 'Scheduler evaluates member Day 2 schedule independently at +48h'],
        ...
        'day_4_business_referral' => [
            ...
            'category' => 'Engagement',
            'category_badge' => 'warning',
            'trigger_type' => 'Time-based (96h post-registration)',
            'trigger_title' => 'Day 4 of 12-day journey (96h post-registration)',
            'when_sent' => 'Sent on Day 4 of the Daily Habit Loop journey exactly 96 hours after registration to follow up on referral activities.',
            ...
            'workflow_steps' => [
                ['title' => 'Day 4 Due', 'desc' => 'Scheduler evaluates member Day 4 schedule independently at +96h'],
        ...
        'day_7_introduce_yourself_circle' => [
            ...
            'category' => 'Engagement',
            'category_badge' => 'warning',
            'trigger_type' => 'Time-based (168h post-registration)',
            'trigger_title' => 'Day 7 of 12-day journey (168h post-registration)',
            'when_sent' => 'Sent on Day 7 of the Daily Habit Loop journey exactly 168 hours after registration prompting member to post introduction in their circle.',
            ...
            'workflow_steps' => [
                ['title' => 'Day 7 Due', 'desc' => 'Scheduler evaluates member Day 7 schedule independently at +168h'],
