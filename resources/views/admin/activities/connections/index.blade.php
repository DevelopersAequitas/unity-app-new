...
<div class="space-y-4">
    @include('admin.activities.partials.header', [
        'title' => 'Connections',
        'actionButton' => '<a href="' . route('admin.activities.connections.export', request()->except(['page'])) . '" class="btn btn-sm btn-outline-primary d-inline-flex align-items-center gap-1 px-3 py-2 fw-semibold" style="border-radius: 10px;"><i class="bi bi-file-earmark-arrow-down"></i> Export CSV</a>'
    ])
                    ...
                    <table class="table table-sm table-hover mb-0 align-middle" style="font-size:12px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="py-2">
                                    <div class="fw-bold text-dark" style="max-width:130px;">
                    ...
                    <table class="table table-sm table-hover mb-0 align-middle" style="font-size:12px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="ps-3 py-2"><span class="rank-badge {{ $i===0?'rank-1':($i===1?'rank-2':($i===2?'rank-3':'rank-other')) }}">{{ $i+1 }}</span></td>
                                <td class="py-2">
                                    <div class="fw-bold text-dark" style="max-width:140px;">
                                        @if(!empty($m->member_id))
                                            <a href="#" class="text-indigo-600 hover:text-indigo-800 hover:underline font-semibold no-underline" onclick="event.preventDefault(); openActivityPeerModal('{{ $m->member_id }}', event);">
                                                {{ $m->member_name }}
                                            </a>
