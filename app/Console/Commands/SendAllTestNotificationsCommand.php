    ...
    public function handle(FcmService $fcmService): int
    {
        ...
        $notificationSamples = [
            ...
            [
                ...
                'body' => 'Your membership will expire in 3 days. Tap to renew now.',
                'screen' => '/profile',
                'priority' => 'high',
                'data' => [
            ...
            [
                ...
                'body' => 'Design Thinkers Circle added 12 new members this week. Join now!',
                'screen' => '/circle-details',
                'priority' => 'medium',
                'data' => [
                    'navigation_screen' => '/circle-details',
                    'type' => 'trending_circle',
