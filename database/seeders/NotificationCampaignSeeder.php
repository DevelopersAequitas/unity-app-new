...
class NotificationCampaignSeeder extends Seeder
{
    ...
    {
        return [
            ['code'=>'new_post_activity_circle','name'=>'New Post / Activity In Circle','category'=>'feed','channel'=>'push','trigger_type'=>'post_or_circle_activity','frequency'=>'real_time_or_digest','priority'=>'medium','audience_type'=>'circle_members_and_connections','title_template'=>'New post by <person>','body_template'=>'[Post Preview Content]...','tap_screen'=>'post_details','description'=>'Keeps close network updated on posts, driving instant comments, likes, and feed activity.','daily_limit'=>2,'cooldown_hours'=>1,'is_active'=>true,'config'=>['business_value'=>'Increase feed engagement','placeholders'=>['person','post_preview_content','circle_name']]],
