...
class EventRegistrationResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'qr_code_url' => ($this->payment_required ?? false) && ($this->payment_status ?? null) !== 'paid' ? null : ($this->qr_code_path ? $qr->url($this->qr_code_path) : ($this->event_id && $this->id ? $qr->url('event-qrcodes/'.$this->event_id.'/'.$this->id.'.png') : $this->qr_code_url)),
