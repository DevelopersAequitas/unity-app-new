            ...
            <div class="card">
                ...
                <div class="card-body row g-3">
                    <div class="col-md-3">
                        ...
                        <input id="price_monthly" type="number" step="0.01" min="0" name="price_monthly" class="form-control @error('price_monthly') is-invalid @enderror" value="{{ old('price_monthly') }}">
                        @error('price_monthly')
                    ...
                    <div class="col-md-3">
                        ...
                        <input id="price_quarterly" type="number" step="0.01" min="0" name="price_quarterly" class="form-control @error('price_quarterly') is-invalid @enderror" value="{{ old('price_quarterly') }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <input id="price_half_yearly" type="number" step="0.01" min="0" name="price_half_yearly" class="form-control @error('price_half_yearly') is-invalid @enderror" value="{{ old('price_half_yearly') }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <input id="price_yearly" type="number" step="0.01" min="0" name="price_yearly" class="form-control @error('price_yearly') is-invalid @enderror" value="{{ old('price_yearly') }}">
                        @error('price_yearly')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
