@php
    ...
    $iconMap = [
        ...
        'ded'               => 'bi-building',
        'eed'               => 'bi-building-fill',
        'id'                => 'bi-briefcase-fill',
        'industry_director' => 'bi-briefcase-fill',
        'circle_leader'     => 'bi-diagram-3-fill',
        'cd'                => 'bi-circle-fill',
        'cf'                => 'bi-circle',
        'founder'           => 'bi-award-fill',
        'director'          => 'bi-person-video3',
        'chair'             => 'bi-person-badge-fill',
        'vice_chair'        => 'bi-person-badge',
        'secretary'         => 'bi-journal-text',
        'committee_leader'  => 'bi-people-fill',
        'member'            => 'bi-person-fill',
        'marketing_team'    => 'bi-megaphone-fill',
        'analytics_team'    => 'bi-bar-chart-fill',
        'content_team'      => 'bi-file-earmark-text-fill',
        'read_only'         => 'bi-eye-fill',
    ];
