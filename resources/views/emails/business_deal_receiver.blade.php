...
Congratulations! You’ve just <strong>received a business deal</strong> from {{ $actorName ?? '' }} worth ₹{{ $dealAmountInr ?? '' }}.<br /><br />
This deal is a testimony to the trust, collaboration, and opportunities created within Peers Global.Keep engaging, keep sharing, and continue growing stronger with every connection.Wishing you continued success,<br /><br />
