@php
    $isAdmin = auth('admin')->check() || request()->is('admin*');
@endphp
    ...
    <div class="access-denied-wrapper">
        <div class="access-card text-center p-4 p-sm-5">
            ...
            <p class="text-secondary fs-6 mb-4 px-sm-2" style="max-width: 440px; margin-left: auto; margin-right: auto;">
                {{ (isset($exception) && $exception->getMessage()) ? $exception->getMessage() : ($message ?? 'You do not have permission to access or modify this page with your current role.') }}
            </p>
...
<head>
    ...
    <title>Access Restricted - 403</title>
    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6 text-center">
                <div class="error-card p-4 p-sm-5">
                    <div class="icon-aura">
                        <div class="icon-badge">
                            <i class="bi bi-shield-lock-fill"></i>
                        </div>
                    </div>
                    <div class="text-danger fw-bold text-uppercase small tracking-wider mb-1">HTTP 403 • Access Restricted</div>
                    <h2 class="fw-bold text-white mb-2">Access Restricted</h2>
                    <p class="text-secondary mb-4 fs-6">
                        {{ (isset($exception) && $exception->getMessage()) ? $exception->getMessage() : ($message ?? 'You do not have permission to access this resource.') }}
                    </p>
                    <div class="d-flex flex-wrap align-items-center justify-content-center gap-3">
                        <button type="button" onclick="window.history.back()" class="btn-action-secondary">
                            <i class="bi bi-arrow-left"></i> Go Back
