...
Schedule::command('memberships:send-expiry-reminders')->dailyAt('11:25')->timezone('UTC');
Schedule::command('memberships:send-upcoming-expiry-reminders')->dailyAt('11:25')->timezone('UTC');
Schedule::command('memberships:send-circle-expiry-reminders')->dailyAt('11:25')->timezone('UTC');

// Connections pending reminders (push + in-app)
Schedule::command('connections:send-pending-reminders')->dailyAt('09:00')->timezone('UTC');

// Brand Partner Offer Expiry reminders (in-app notifications)
Schedule::command('PGU:brand-partner-expiry-alerts')->dailyAt('08:00')->timezone('UTC');
...
Schedule::command('notifications:campaigns daily')->dailyAt('09:15')->timezone('UTC');
Schedule::command('notifications:campaigns weekly')->sundays()->at('18:00')->timezone('UTC');
