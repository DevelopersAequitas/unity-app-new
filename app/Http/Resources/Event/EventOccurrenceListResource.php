...
class EventOccurrenceListResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'enable_qr_checkin' => (bool) $event->qr_checkin_enabled,
            'enable_member_registration' => $eventService->memberRegistrationEnabled($event),
            'enable_visitor_registration' => $visitorRegistrationEnabled,
            'visibility' => $event->visibility,
            'status' => $event->status ?? 'scheduled',
            'recurrence_type' => $event->recurrence_type ?? 'none',
            'is_recurring' => ($event->recurrence_type ?? 'none') !== 'none',
