@php
    $certificateTitle = 'Leadership Certification';
    $recipientName = $submission->full_name ?: 'Peer';
    $businessName = $submission->business_name ?: 'N/A';
    $certificationLevel = $submission->certification_level ?: 'N/A';
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="width:100%; border:1px solid #4b2a91; border-radius:12px; background-color:#1b1b1f; margin:0 0 24px;">
                                <tr>
                                    <td style="padding:22px 20px; text-align:center; border-bottom:1px solid #33205f;">
                                        ...
                                        <div style="margin-top:8px; color:#ffffff; font-size:20px; line-height:28px; font-weight:bold;">{{ $certificationLevel !== 'N/A' ? $certificationLevel : $certificateTitle }}</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:18px 20px;">
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="width:100%;">
                                            ...
                                            <tr>
                                                <td style="padding:8px 0; color:#b8b8c4; font-size:14px; line-height:20px;">Level</td>
                                                <td style="padding:8px 0; color:#c9a8ff; font-size:14px; line-height:20px; font-weight:bold;">{{ $certificationLevel }}</td>
                                            </tr>
                                            <tr>
