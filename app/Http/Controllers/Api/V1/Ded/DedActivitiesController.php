...
class DedActivitiesController extends DedBaseController
{
    ...
    {
        return $this->index($request, 'testimonials');
    }

    public function testimonialShow(Request $request, string $id)
    {
        return $this->show($request, 'testimonials', $id);
    }

    public function requirements(Request $request)
    {
        return $this->index($request, 'requirements');
    }

    public function requirementShow(Request $request, string $id)
    {
        return $this->show($request, 'requirements', $id);
    }

    public function referrals(Request $request)
    {
        return $this->index($request, 'referrals');
    }

    public function referralShow(Request $request, string $id)
    {
        return $this->show($request, 'referrals', $id);
    }

    public function p2pMeetings(Request $request)
    {
        return $this->index($request, 'p2p-meetings');
    }

    public function p2pMeetingShow(Request $request, string $id)
    {
        return $this->show($request, 'p2p-meetings', $id);
    }

    public function businessDeals(Request $request)
    {
        return $this->index($request, 'business-deals');
    }

    public function businessDealShow(Request $request, string $id)
    {
        return $this->show($request, 'business-deals', $id);
    }

    public function becomeALeader(Request $request)
    {
        return $this->index($request, 'become-a-leader');
    }

    public function recommendAPeer(Request $request)
    {
        return $this->index($request, 'recommend-a-peer');
    }

    public function findBuildCollaborations(Request $request)
    {
        return $this->index($request, 'find-build-collaborations');
    }

    public function registerAVisitor(Request $request)
    {
        return $this->index($request, 'register-a-visitor');
    }
