...
<div class="container-fluid px-0">
    ...
    @if (! $isCircleSelected)
        <div class="card border-0 shadow-sm p-5 text-center rounded-4 mb-4">
            <div class="py-5">
                <div class="kpi-icon-wrapper bg-icon-primary mx-auto mb-4" style="width: 72px; height: 72px; font-size: 2.5rem;">
                    <i class="bi bi-diagram-3-fill"></i>
                </div>
                <h4 class="fw-bold text-dark mb-2">No Circles Assigned</h4>
                <p class="text-muted mx-auto" style="max-width: 480px;">
                    You are currently not assigned to any circles. Please contact the administrator.
                </p>
            </div>
        </div>
    @else
