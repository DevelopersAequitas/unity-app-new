...
<div class="card ac-card labels-card">
    ...
    <form method="GET" action="{{ route('admin.app-config.index') }}" class="card-body border-bottom">
        <input type="hidden" name="tab" value="labels">
        <div class="toolbar row g-2 mb-0">
            <div class="col-md-5">
                <input class="form-control" name="label_search" value="{{ request('label_search') }}" placeholder="Search labels by key, value, group, or description">
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-2 d-flex gap-2">
                <button class="btn btn-success flex-fill" type="submit">Apply</button>
                <a class="btn btn-outline-secondary" href="{{ route('admin.app-config.index', ['tab' => 'labels']) }}">Reset</a>
            </div>
        </div>
    </form>
