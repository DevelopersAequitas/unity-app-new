...
use App\Http\Controllers\Admin\ActivitiesFollowsController;
use App\Http\Controllers\Admin\ActivitiesLeaderInterestController;
use App\Http\Controllers\Admin\ActivitiesMessagesController;
...
use App\Http\Controllers\Admin\NotificationMonitoringController;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin.auth', 'admin.role', 'admin.circle', 'admin.permission'])->group(function () {
        ...
        Route::get('/activities/follows', [ActivitiesFollowsController::class, 'index'])->name('activities.follows.index');
        Route::get('/activities/follows/export', [ActivitiesFollowsController::class, 'export'])->name('activities.follows.export');
        Route::get('/activities/messages', [ActivitiesMessagesController::class, 'index'])->name('activities.messages.index');
        Route::get('/activities/messages/conversation/{chatId}', [ActivitiesMessagesController::class, 'conversation'])->name('activities.messages.conversation');
        Route::get('/activities/messages/export', [ActivitiesMessagesController::class, 'export'])->name('activities.messages.export');
        ...
        Route::get('/activities/videos', [ActivityVideoController::class, 'index'])->name('activities.videos.index');
        Route::post('/activities/videos', [ActivityVideoController::class, 'store'])->name('activities.videos.store');
        Route::put('/activities/videos/{id}', [ActivityVideoController::class, 'store'])->name('activities.videos.update')->whereUuid('id');
        Route::patch('/activities/videos/{id}/toggle', [ActivityVideoController::class, 'toggle'])->name('activities.videos.toggle')->whereUuid('id');
        Route::delete('/activities/videos/{id}', [ActivityVideoController::class, 'destroy'])->name('activities.videos.destroy')->whereUuid('id');
        ...
        Route::get('/notifications/monitoring', [NotificationMonitoringController::class, 'index'])->name('notifications.monitoring');
        Route::get('/notifications/monitoring/{id}/details', [NotificationMonitoringController::class, 'details'])->whereUuid('id')->name('notifications.monitoring.details');
        Route::get('/notifications/monitoring/export', [NotificationMonitoringController::class, 'export'])->name('notifications.monitoring.export');
