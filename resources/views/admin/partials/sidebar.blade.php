@php
    ...
    $fullActivityMenu = [
        ...
        ['label' => 'Connections', 'route' => 'admin.activities.connections.index', 'active_routes' => ['admin.activities.connections*']],
        ['label' => 'Follows', 'route' => 'admin.activities.follows.index', 'active_routes' => ['admin.activities.follows*']],
        ['label' => 'Messages', 'route' => 'admin.activities.messages.index', 'active_routes' => ['admin.activities.messages*']],
