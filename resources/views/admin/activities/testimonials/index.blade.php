    ...
    <div id="grid-root-container" class="light rounded-xl border bs p-4 relative admin-grid-card space-y-4">
        ...
        <div class="activities-stats-grid">
            <div class="activity-metric-card cursor-pointer hover:shadow-md transition"
                 onclick="document.getElementById('testimonialsLogGrid')?.scrollIntoView({ behavior: 'smooth' })"
                 title="Click to jump to Testimonials Log"
                ...
                <div>
                    ...
                    <div class="metric-label">
                        Total Testimonials <i class="bi bi-arrow-down-short ms-0.5 text-muted"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="activity-metric-card cursor-pointer hover:shadow-md transition"
                 onclick="window.location.href='{{ route('admin.activities.testimonials.index', array_merge(request()->except(['media', 'page']), ['media' => 'yes'])) }}#testimonialsLogGrid'"
                 title="Click to filter testimonials with attachments"
                 style="cursor: pointer;">
        ...
        <form id="testimonialsFiltersForm" method="GET" action="{{ route('admin.activities.testimonials.index') }}" class="space-y-4">
            ...
            <div class="space-y-4">
                ...
                <!-- All Logs Grid -->
                <div id="testimonialsLogGrid" class="rounded-xl border bs surface overflow-hidden">
                    <div class="px-4 py-3 surface-2 border-b bs flex justify-between items-center">
