            ...
            <table class="table table-hover align-middle mb-0">
                ...
                @forelse($events as $event)
                    <tr>
                        ...
                        <td><a class="btn btn-sm btn-outline-primary" href="{{ route('admin.events.show', $event->id) }}">View</a> <a class="btn btn-sm btn-outline-secondary" href="{{ route('admin.events.edit', $event->id) }}">Edit</a> <a class="btn btn-sm btn-outline-success" href="{{ route('admin.events.attendance', $event->id) }}">Attendance</a> <a class="btn btn-sm btn-outline-info" href="{{ route('admin.events.scanners.index', $event->id) }}">Scanners</a></td>
                    </tr>
                @empty
